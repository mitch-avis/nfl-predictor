# Delegation guardrails: why each rule exists

The incidents behind each rule in "Delegation guardrails" in `AGENTS.md`. The full records are
in `.agents/ARCHIVE.md` (Milestone 59, "Audit", and Milestone 55, "55.8").
